...
ui <- fluidPage(
  ...
  headerPanel(title=div(a(img(src='../www/MSbrowser_logo_tricolour_alpha.png'), href='https://tkimhofer.github.io/msbrowser/index.html', target="_blank")), windowTitle='MSbrowser'),
